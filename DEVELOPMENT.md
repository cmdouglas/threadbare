...
9. Optional, once the sync worker exists: a small script to post a batch of synthetic messages into the test server, for exercising pagination/backfill/search at volume.
